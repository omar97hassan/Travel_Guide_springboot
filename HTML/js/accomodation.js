...
function populateCards(city) {
	...
	function initialize(codedlat, codedlng) {
		...
		service.nearbySearch(accomodationRequest, hotel);
	}

	function hotel(results, status) {
	  	if (status == google.maps.places.PlacesServiceStatus.OK) {
	  		console.log(results);

	  		$(".accomodationCards").html("");
            ...
            var pattern = '<div class="col-xs-12 col-md-4 grid-item">\
                        <div class="card placeCard" data-search="'+results[i].name+' '+ results[i].vicinity +'">\
                          ...
                          <div class="card-body">\
                            <div class="card-text">\
                                ...
                                <h6 ><span class="fa fa-map-marker-alt"></span><span class="placeAddress">'+ results[i].vicinity +'</span></h6>\
                                <p> Price Range: <span class="priceRange">'+'\
                                </span> </p>\
             ...
             $(".accomodationCards").append(pattern);
